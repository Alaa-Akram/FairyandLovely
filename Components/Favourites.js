...
const Favourites = () => {
  ...
  return (
    <ScrollView numColumns={2} >
      ...
      <View  style={{marginLeft:10,  flexDirection:'column', gap:7, backgroundColor:'white',  alignItems:'center',height:244,width:175 ,borderBottomRightRadius:10,borderBottomLeftRadius:10, marginTop:15 }}>
...
>
  ...
  />
     ...
     <View  style={{marginLeft:20,  flexDirection:'column', gap:7, backgroundColor:'white',  alignItems:'center',height:244,width:175 ,borderBottomRightRadius:10,borderBottomLeftRadius:10, marginTop:15 }}>
